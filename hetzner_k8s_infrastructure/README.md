...
7. **Global helm chart for hetzner_demo apps** no need to maintain plain manifests, overlays or individual helm chart for apps, only values needed to override in argocd app manifest
