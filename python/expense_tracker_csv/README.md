...
A command-line expense tracker written in Python. Log daily expenses by category, view your spending history, and calculate monthly totals — all stored locally in a CSV file with no external dependencies.
