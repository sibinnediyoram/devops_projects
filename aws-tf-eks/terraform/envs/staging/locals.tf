locals {
  environment     = "staging"
  region          = "eu-central-1"
  cluster_name    = "lemon-staging"
  cluster_version = "1.33"

  vpc_cidr = "10.1.0.0/16"

  public_subnets = [
    { az = "eu-central-1a", cidr = "10.1.1.0/24" },
    { az = "eu-central-1b", cidr = "10.1.2.0/24" },
    { az = "eu-central-1c", cidr = "10.1.3.0/24" },
  ]
  private_subnets = [
    { az = "eu-central-1a", cidr = "10.1.11.0/24" },
    { az = "eu-central-1b", cidr = "10.1.12.0/24" },
    { az = "eu-central-1c", cidr = "10.1.13.0/24" },
  ]
