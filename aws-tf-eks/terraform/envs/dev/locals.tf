locals {
  environment     = "dev"
  region          = "eu-central-1"
  cluster_name    = "lemon-dev"
  cluster_version = "1.33"

  vpc_cidr = "10.0.0.0/16"

  public_subnets = [
    { az = "eu-central-1a", cidr = "10.0.1.0/24" },
    { az = "eu-central-1b", cidr = "10.0.2.0/24" },
    { az = "eu-central-1c", cidr = "10.0.3.0/24" },
  ]
  private_subnets = [
    { az = "eu-central-1a", cidr = "10.0.11.0/24" },
    { az = "eu-central-1b", cidr = "10.0.12.0/24" },
    { az = "eu-central-1c", cidr = "10.0.13.0/24" },
  ]
